...
pub fn dispatch(state: &Mutex<State>, method: &str, url: &str, body: &str, seat: &str) -> Reply {
    ...
    match (method, url) {
        ...
        ("GET", "/v1/privacy") => social::privacy(state, seat),
        ("POST", "/v1/privacy") => social::set_policy(state, seat, body),
        ("POST", "/v1/privacy/block") => social::block(state, seat, body),
        ("POST", "/v1/privacy/unblock") => social::unblock(state, seat, body),
        ("POST", "/v1/privacy/archive") => social::archive(state, seat, body),
        ("POST", "/v1/privacy/unarchive") => social::unarchive(state, seat, body),
